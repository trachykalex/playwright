import logging
import playwright.synk_api
from playwright.synk_api import Route, Request, ConsoleMessage, Dialog
...
class App:
    ...
    def get_location(self):
        return self.page.text_context('.position')
    ...
    def stop_intecept(self, url: str):
    ...
    def get_total_tests_stats(self):
        return self.page.text_context('.total >> span')
